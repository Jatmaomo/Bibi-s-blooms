        ...
        <div className="flex items-center justify-between h-20">
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2 text-sm font-medium tracking-wider uppercase transition-all duration-200 rounded-md relative ${
                    active
                ...
                >
                  {item.label}
                  {active && (
                    <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-5 h-0.5 bg-[#c5a059] rounded-full shadow-[0_0_8px_#c5a059]" />
                  )}
                </button>
              );
            })}
          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-mono rounded-full border border-emerald-500/40 text-emerald-400 bg-emerald-950/30 hover:bg-emerald-900/40 transition-colors"
            >
            ...
            {onOpenCart && (
              <button
                ...
                title="View Selected Order Items"
              >
            ...
            <button
              ...
              id="nav-link-admin-desktop"
              className={`inline-flex items-center gap-1.5 px-3.5 py-1.5 text-xs font-semibold tracking-wider uppercase rounded-md border transition-all ${
                currentPage === 'admin'
                  ? 'border-[#c5a059] text-[#c5a059] bg-[#c5a059]/10'
                  : 'border-zinc-700/80 text-zinc-300 hover:text-white hover:border-[#c5a059]'
              }`}
            >
