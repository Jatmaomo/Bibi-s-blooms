...
export const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    description: 'Heavyweight premium denim with wide-leg relaxed skate silhouette, custom brass hardware and subtle distressing.',
    price: 36000,
    category: 'Baggy Jeans',
    image_url: 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?q=80&w=800&auto=format&fit=crop',
  ...
  {
    id: '2',
    name: 'Heavyweight Minimalist Luxury Roundneck',
    description: '280gsm pure combed cotton crewneck t-shirt with ribbed collar and drop-shoulder aesthetic.',
    price: 22000,
    category: 'Roundnecks',
  ...
  {
    id: '3',
    name: 'Double Mercerized Knit Executive Polo',
    description: 'Silky smooth Egyptian cotton polo shirt with ribbed contrast cuffs and three-button placket.',
    price: 32000,
    category: 'Polos',
  ...
  {
    id: '4',
    name: 'Signature Monogram Snapback Cap',
    description: 'High-crown structured 6-panel twill cap with embroidered monogram and matte buckle strap.',
    price: 18000,
    category: 'Caps',
  ...
  {
    id: '5',
    name: 'Ergonomic Leather Strap Comfort Slides',
    description: 'Ultra-cushioned contoured footbed with butter-soft genuine leather strap and traction sole.',
    price: 28000,
    category: 'Slides',
    image_url: 'https://images.unsplash.com/photo-1603808033192-082d6919d3e1?q=80&w=800&auto=format&fit=crop',
  ...
  {
    id: '6',
    name: 'Minimalist Tactile Cross Bag',
    description: 'Weather-resistant ripstop canvas cross body bag with quick-release metal buckle and organizer slots.',
    price: 26000,
    category: 'Cross Bags',
